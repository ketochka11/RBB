...
public class NbrbConversionService {
    public class NbrbCurrencyConversionService implements ConversionService {
        @Override
        public double getConversion(Currency original, Currency target) {
